...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FoodApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7FoodApp11AppDelegate")
...
SWIFT_CLASS("_TtC7FoodApp23RestaurantTableViewCell")
...
SWIFT_CLASS("_TtC7FoodApp29RestaurantTableViewController")
...
SWIFT_CLASS("_TtC7FoodApp14ViewController")
